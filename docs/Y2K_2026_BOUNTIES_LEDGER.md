# 🎯 2026 Y2K WEEKLY CHALLENGES & BOUNTIES LEDGER

**Season**: 2026 Regular Season (Weeks 1–14)  
...
## 💰 2026 BUY-IN ROSTER & TIER STATUS
...
## 📋 PAYOUT RULES & MATHEMATICS

1. **Qualification Rule**:
   - Every franchise enters at $0 cost.
   - **Win #1** across the 14-week slate simply unlocks/qualifies your franchise (payout = $0 net).
2. **Subsequent Wins (Win #2+)**:
   - **Base Tier ($0 Buy-in)**: Pays **$5.00** per subsequent win.
   - **$5 Boost Tier ($5 Buy-in)**: Pays **$10.00** per subsequent win ($5 base + $5 boost).
     - *Breakeven*: 2 wins = +$5 net profit.
   - **$10 Boost Tier ($10 Buy-in)**: Pays **$15.00** per subsequent win ($5 base + $10 boost).
     - *Breakeven*: 2 wins = +$5 net profit.
   - **$20 Max Tier ($20 Buy-in)**: Pays **$25.00** per subsequent win ($5 base + $20 boost).
     - *Breakeven*: 2 wins = +$5 net profit; 3 wins = +$30 net profit; 4 wins = +$55 net profit.
...
- **Week 07**: Air Strike — Highest scoring individual Wide Receiver
- **Week 08**: The Vulture Award — Starting player with lowest total yards who still scored 2+ TDs
- **Week 09**: 12th Man (Bench Hero) — Highest individual scoring player left on a bench
- **Week 10**: The Dimebag — Team with most individual starters scoring double digits (10.0+ pts)
- **Week 11**: Ground & Pound — Highest combined points from starting Running Backs (RB1 + RB2)
